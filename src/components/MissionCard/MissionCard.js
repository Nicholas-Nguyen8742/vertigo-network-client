...
export default function MissionCard({firstName, lastName, profile, date, city, status, specialty, display }) {
    return (
        <article className='missionCard'>
            ...
            <div className='missionCard-right'>
                ...
                <p className='missionCard__body2'style={{display:`${display}`}}>{status}</p>
